...
export type CheckCurrentUserFollowsType =
  (typeof CheckCurrentUserFollowsType)[keyof typeof CheckCurrentUserFollowsType];
...
export type UnfollowArtistsUsersType =
  (typeof UnfollowArtistsUsersType)[keyof typeof UnfollowArtistsUsersType];
...
export type FollowArtistsUsersType =
  (typeof FollowArtistsUsersType)[keyof typeof FollowArtistsUsersType];
...
export type GetFollowedType =
  (typeof GetFollowedType)[keyof typeof GetFollowedType];
...
export type GetUsersTopArtistsAndTracksParams = {
  time_range?: string;
  limit?: QueryLimitParameter;
  offset?: QueryOffsetParameter;
};
...
export type SearchIncludeExternal =
  (typeof SearchIncludeExternal)[keyof typeof SearchIncludeExternal];
...
export type SearchTypeItem =
  (typeof SearchTypeItem)[keyof typeof SearchTypeItem];
 ...
 */
export type SingletonArrayOfBooleanResponse = boolean[];
...
export type PagingArtistOrTrackObjectResponse = PagingObject &
  PagingArtistOrTrackObjectResponseAllOf;

export type PagingArtistOrTrackObjectResponseAllOfItemsItem =
  | ArtistObject
  | TrackObject;

export type PagingArtistOrTrackObjectResponseAllOf = {
  items?: PagingArtistOrTrackObjectResponseAllOfItemsItem[];
};

/**
 * Pages of chapters
 */
export type PagingSimplifiedChapterObjectResponse =
  PagingSimplifiedChapterObject;

/**
 * Pages of audiobooks
 */
export type PagingSimplifiedAudiobookObjectResponse =
 ...
 * Pages of episodes
 */
export type PagingSimplifiedEpisodeObjectResponse =
 ...
 * Pages of albums
 */
export type PagingArtistDiscographyAlbumObjectResponse =
...
export type PagedCategoriesResponseCategories = PagingObject &
  PagedCategoriesResponseCategoriesAllOf;
 ...
 */
export type ChapterBaseType =
  (typeof ChapterBaseType)[keyof typeof ChapterBaseType];
 ...
 */
export type ChapterBaseReleaseDatePrecision =
  (typeof ChapterBaseReleaseDatePrecision)[keyof typeof ChapterBaseReleaseDatePrecision];
 ...
 */
export type ArtistDiscographyAlbumObjectAllOfAlbumGroup =
  (typeof ArtistDiscographyAlbumObjectAllOfAlbumGroup)[keyof typeof ArtistDiscographyAlbumObjectAllOfAlbumGroup];
 ...
 */
export type AlbumBaseReleaseDatePrecision =
  (typeof AlbumBaseReleaseDatePrecision)[keyof typeof AlbumBaseReleaseDatePrecision];
 ...
 */
export type AlbumBaseAlbumType =
  (typeof AlbumBaseAlbumType)[keyof typeof AlbumBaseAlbumType];
...
export type SimplifiedAudiobookObject = AudiobookBase &
  SimplifiedAudiobookObjectAllOf;
 ...
 */
export type AudiobookBaseType =
  (typeof AudiobookBaseType)[keyof typeof AudiobookBaseType];
...
export type SimplifiedShowObjectAllOf = { [key: string]: unknown };

export type SimplifiedShowObject = ShowBase & SimplifiedShowObjectAllOf;
 ...
 */
export type EpisodeBaseType =
  (typeof EpisodeBaseType)[keyof typeof EpisodeBaseType];
 ...
 */
export type EpisodeBaseReleaseDatePrecision =
  (typeof EpisodeBaseReleaseDatePrecision)[keyof typeof EpisodeBaseReleaseDatePrecision];
...
export type TrackObjectType =
  (typeof TrackObjectType)[keyof typeof TrackObjectType];
 ...
 */
export type PlaylistUserObjectType =
  (typeof PlaylistUserObjectType)[keyof typeof PlaylistUserObjectType];
 ...
 */
export type AudioFeaturesObjectType =
  (typeof AudioFeaturesObjectType)[keyof typeof AudioFeaturesObjectType];
 ...
 */
export type SectionObjectMode =
  (typeof SectionObjectMode)[keyof typeof SectionObjectMode];
 ...
 */
export type PublicUserObjectType =
  (typeof PublicUserObjectType)[keyof typeof PublicUserObjectType];
...
export type SimplifiedArtistObjectType =
  (typeof SimplifiedArtistObjectType)[keyof typeof SimplifiedArtistObjectType];
...
export type ArtistObjectType =
  (typeof ArtistObjectType)[keyof typeof ArtistObjectType];
 ...
 */
export type AlbumRestrictionObjectReason =
  (typeof AlbumRestrictionObjectReason)[keyof typeof AlbumRestrictionObjectReason];
...
export const createPlaylist = <TData = AxiosResponse<OnePlaylistResponse>>(
  ...
  return axios.post(`/users/${userId}/playlists`, createPlaylistBody, options);
};
